  ...
  const testimonials = [
    {
      name: "Анна Петрова",
      role: "Мама ученика",
      text: "Елена Владимировна — настоящий профессионал! Моя дочь повысила балл с 45 до 78 за полгода подготовки. Занятия проходили интересно, дочь с удовольствием изучала русский язык.",
    ...
    },
    {
      ...
      text: "Благодаря занятиям с Еленой Владимировной сдал ЕГЭ по русскому языку на 89 баллов и поступил в РУДН! Объясняет очень понятно, всегда поддерживает и верит в успех.",
    ...
    },
    {
      name: "Мария Сидорова",
      role: "Выпускница",
      text: "Русский язык был моим слабым местом, но после года занятий сдала ЕГЭ на 85 баллов! Елена Владимировна умеет найти подход и объяснить самые сложные правила простым языком.",
